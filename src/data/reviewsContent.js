const reviewsContent = {
  seoTitle: 'Отзывы клиентов об электротехнической лаборатории ЦЭФ | Благодарности',
  seoDescription:
    'Реальные отзывы заказчиков о работе ООО Центр Энергоэффективности. Узнайте мнение компаний Нижнего Новгорода о качестве и скорости наших испытаний.',
  title: 'Что говорят наши клиенты',
  subtitle: 'Реальные отзывы от компаний, с которыми мы работаем',
  homeTitle: 'Что говорят наши клиенты',
  items: [
    {
      id: 'review-1',
