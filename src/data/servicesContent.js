const servicesContent = {
  seoTitle: 'Услуги электролаборатории до 110 кВ | Поиск обрыва кабеля | ЦЭФ',
  seoDescription:
    'Проведение электроизмерений, испытания электрооборудования до 110 кВ, наладка РЗиА, поиск повреждения кабеля. Выезд лаборатории по Нижнему Новгороду и РФ.',
  badgeLabel: 'Свидетельство №1428',
  pageTitle: 'Услуги электролаборатории',
  pageSubtitle:
    'Полный спектр испытаний электрооборудования до 110 кВ. Аттестация Ростехнадзора. Официальные протоколы за 24 часа.',
  tabs: [
  ...
  sections: [
    {
      ...
      description:
        'Полный комплекс испытаний электрооборудования высокого напряжения согласно ПТЭЭП и ГОСТ.',
      services: [
    ...
    },
    {
      ...
      description:
        'Наладка, проверка и расчет уставок устройств РЗиА. Новое включение и периодические проверки.',
      services: [
    ...
    },
    {
      ...
      description:
        'Диагностика силовых трансформаторов до 110 кВ. Анализ трансформаторного масла.',
      services: [
    ...
    },
    {
      ...
      description:
        'Испытания электрооборудования до 1000 В. Измерение изоляции, заземления, петли фаза-ноль.',
      services: [
        ...
        { name: 'Испытание автоматов', detail: 'До 1000 А' },
    ...
    },
    {
      ...
      description:
        'Проверка систем молниезащиты и заземляющих устройств согласно РД 34.21.122-87 и СО 153-34.21.122-2003.',
      services: [
    ...
    },
    {
      ...
      description:
        'Электромонтаж, реконструкция и модернизация электрооборудования. Ретрофит ячеек 6-10 кВ.',
      services: [
        ...
        { name: 'Сборка и монтаж щитов', detail: 'До 1000 В' },
      ],
    },
  ],
  ctaTitle: 'Нужна консультация по испытаниям?',
  ctaText:
    'Оставьте заявку, и наш инженер свяжется с вами для уточнения деталей и расчета стоимости.',
  ctaButtonLabel: 'Позвонить',
};
