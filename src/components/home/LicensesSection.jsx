...
import { Shield, Award, FileCheck, X, ZoomIn, Download } from 'lucide-react';
    ...
    return (
        <section className="py-20 bg-white">
            <div className="container mx-auto px-4">
                ...
                >
                    <span className="text-orange-500 font-semibold text-sm uppercase tracking-wider">Документы</span>
